    ...
    if (isError || !post) {
        return (
            <div className="text-center py-24">
                ...
                <Link href="/blog" className="mt-6 inline-block text-brand-gold hover:underline">&larr; Back to Blog</Link>
            </div>
        );
    }
            ...
            <div className="container mx-auto px-4">
                <article className="max-w-4xl mx-auto">
                    <header className="text-center mb-12">
                        <Link href="/blog" className="text-sm text-brand-gold hover:underline mb-4 inline-block">&larr; Back to all posts</Link>
