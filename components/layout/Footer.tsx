                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm">
                            <li><Link href="/about" className="text-brand-text-dark hover:text-brand-gold transition-colors">About Us</Link></li>
                            <li><Link href="/leadership" className="text-brand-text-dark hover:text-brand-gold transition-colors">Leadership</Link></li>
                            <li><Link href="/light-campuses" className="text-brand-text-dark hover:text-brand-gold transition-colors">Light Campuses</Link></li>
                            <li><Link href="/blog" className="text-brand-text-dark hover:text-brand-gold transition-colors">Blog</Link></li>
                            <li><Link href="/teachings" className="text-brand-text-dark hover:text-brand-gold transition-colors">Teachings</Link></li>
                            <li><Link href="/events" className="text-brand-text-dark hover:text-brand-gold transition-colors">Events</Link></li>
                            <li><Link href="/prayer" className="text-brand-text-dark hover:text-brand-gold transition-colors">Prayer Wall</Link></li>
                            <li><Link href="/testimonies" className="text-brand-text-dark hover:text-brand-gold transition-colors">Testimonies</Link></li>
                            <li><Link href="/ministries" className="text-brand-text-dark hover:text-brand-gold transition-colors">Ministries</Link></li>
                            <li><Link href="/serve" className="text-brand-text-dark hover:text-brand-gold transition-colors">Serve</Link></li>
                            <li><Link href="/give" className="text-brand-text-dark hover:text-brand-gold transition-colors">Give</Link></li>
                            <li><Link href="/contact" className="text-brand-text-dark hover:text-brand-gold transition-colors">Contact</Link></li>
                        </ul>
                    </div>
