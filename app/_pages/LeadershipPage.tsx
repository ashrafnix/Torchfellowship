            ...
            <section className="py-24 bg-brand-dark">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
                        <Button size="lg" variant="primary" as={Link} href="/leaders">Meet Our Leaders</Button>
                        <Button size="lg" variant="secondary" as={Link} href="/serve">Find a Place to Serve</Button>
                    </div>
                </div>
            </section>
        </div>
