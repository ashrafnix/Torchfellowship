...
import { Teaching, Event, BlogPost } from '@/lib/types';
        ...
        <div className="container mx-auto px-4 relative z-10">
          <AnimatedSection>
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4">
              <Button size="lg" variant="primary" as={Link} href="/join-us">Join Our Community</Button>
              <Button size="lg" variant="secondary" as={Link} href="/teachings">Watch Teachings</Button>
            </div>
          </AnimatedSection>
        </div>
      </section>
    ...
    <div>
      ...
      <div className="bg-brand-surface rounded-lg shadow-2xl overflow-hidden h-fit">
        ...
        <div className="p-6">
            ...
            <Link href="/teachings" className="text-brand-gold hover:underline mt-4 inline-block font-semibold text-sm">View All Teachings &rarr;</Link>
        </div>
      </div>
    </div>
  )
    ...
    <div>
      ...
      <div className="bg-brand-surface rounded-lg shadow-2xl overflow-hidden h-fit">
        ...
        <div className="p-6">
            ...
            <Link href="/events" className="text-brand-gold hover:underline mt-4 inline-block font-semibold text-sm">View All Events &rarr;</Link>
        </div>
      </div>
    </div>
  )
